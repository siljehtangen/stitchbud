...
export const COLOR_MAP: Record<string, string> = Object.fromEntries(COLORS.map(c => [c.name, c.hex]))

export const COLOR_MAP_BY_HEX: Record<string, ColorOption> = Object.fromEntries(COLORS.map(c => [c.hex, c]))
